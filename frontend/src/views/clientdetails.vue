...
<template>
  <main>
    ...
    <div class="px-10 py-20">
      <!-- grid container -->
      <!--Field containing the profile picture, class types copied from similar code bellow the added code-->
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-10">   
        <h4 class="text-2xl font-bold">Profile Picture</h4>
        <div class="flex flex-col">
          <!--puts the profile picture here on the page-->
          <profile-picture :client="client"></profile-picture>
        </div>
      </div>
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-10">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-10">
        ...
        <div class="flex justify-between mt-10 mr-20">
          <button @click="openConfirmationDialog" type="submit" class="bg-red-700 disabled:opacity-50 text-white rounded"
            :disabled="user.role === 'viewer'">
            Delete Client
          </button>
          ...
          <!--Confirmation Dialog component-->
            ...
            @confirmed="submitDeleteClient"
            @canceled="closeConfirmationDialog"
          />
...
export default {
  ...
  components: {
    VueMultiselect,
    //confirmation dialog calling
    ConfirmationDialog,
    
    //call the profilePicture.vue component
    profilePicture
  },
  setup() {
